    ...
    <ScreenWrap>
      ...
      {usage && (
        <Card style={{ marginTop: 18 }}>
          ...
          />
          <UsageRow label="Планы" used={usage.plans_this_week} limit={cur.plansPerWeek} />
          <UsageRow label="Анализы" used={usage.analyses} limit={cur.analysesPerMonth} />
        </Card>
      )}
...
// --- pieces (общие со старой /billing-страницей) ---
    ...
    <div style={{ marginBottom: 12 }}>
      ...
      >
        ...
        <span style={{ color: over ? WARN : MUTED, fontWeight: 600 }}>
          {used}
          <span style={{ color: MUTED }}> / {unlimited ? "∞" : limit}</span>
        </span>
      </div>
      <div
        style={{
      ...
      >
        <div
          style={{
            ...
            background: unlimited ? "rgba(245,231,10,0.3)" : over ? WARN : YELLOW,
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "right" }}>
          {isFree ? (
            <span style={{ fontSize: 13, color: MUTED, fontWeight: 600 }}>0 ₽</span>
          ) : (
            <>
              {originalPrice && (
                <div
