...
type Props = {
  ...
  variant?: "value_moment" | "limit_reached" | "deep_dive" | "pro_feature";
  ...
  const subtitle =
    variant === "value_moment"
      ...
      : variant === "deep_dive"
        ...
        : variant === "pro_feature"
          ? "Все стили подписей, слайды карусели и контент-пакеты без ограничений. Плюс до 30 разборов в месяц."
