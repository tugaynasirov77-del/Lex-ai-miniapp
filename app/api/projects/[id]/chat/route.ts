...
function buildSystem(p: {
  ...
  return (
    ...
    "Пиши ОБЫЧНЫМ текстом, без markdown: не используй звёздочки **, решётки #, подчёркивания для выделения. " +
    "Всегда опирайся на нишу и аудиторию пользователя. " +
    "Приветствие и знакомство уже состоялись в начале чата — НЕ здоровайся повторно, не представляйся и не повторяй имя, сразу отвечай по сути. " +
